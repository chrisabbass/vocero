...
export type Personality = 'direct' | 'friendly' | 'inspiring';
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <ToggleGroupItem 
          value="inspiring" 
          aria-label="Inspiring tone" 
          className={`flex items-center gap-2 transition-all ${personality === 'inspiring' ? 'bg-primary text-primary-foreground shadow-md scale-105' : ''}`}
        >
